...
static const char auth_key_test[] = "mVPUHPzCnpIq9YObJcIANOq6tzHZoGUl";
static const char device_id_test[] = "tuya283b41c3fa61";
static const uint8_t mac_test[6] = {0x8D,0x6F,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D316F8D
